...
public class SellerPicRet extends BaseRet{
    Data data;
    ...
    public class Data {
        ...
        String billQQNum;		//出货QQ号码
        String billQQPwd;		//出货QQ密码
        ...
        public String getBillQQNum() {
            return billQQNum;
        }

        public void setBillQQNum(String billQQNum) {
            this.billQQNum = billQQNum;
        }

        public String getBillQQPwd() {
            return billQQPwd;
        }

        public void setBillQQPwd(String billQQPwd) {
            this.billQQPwd = billQQPwd;
        }
