...
public class SellerPretrialActivity extends BaseActivity implements CallbackUtils.ResponseCallback {
    ...
    private TextView tv_reserveAccount,tv_productInfo,tv_reserveInfo,tv_succQBCount,tv_succMoney,tv_confirmTypeStr,tv_noticeMobile,tv_rechargeTime,
            tv_finishTime,tv_receiveOrderNum,tv_onceLimit,tv_buyerAccount,tv_buyerRealName,tv_sellerAccount,tv_sellerRealName,tv_noticeEmail,
            tv_createTime,tv_penaltyMoney,tv_autoConfirmTime,tv_averageConfirmTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_pretrial_layout);
        ...
        tv_reserveAccount = (TextView)findViewById(R.id.tv_reserveAccount);
        ...
        tv_noticeMobile = (TextView)findViewById(R.id.tv_noticeMobile);
        ...
        tv_noticeEmail = (TextView)findViewById(R.id.tv_noticeEmail);
        ...
        tv_title_content.setText("卖家出售预审");
        ...
        CallbackUtils.setCallback(SellerPretrialActivity.this);
        if(!TextUtils.isEmpty(auditId)){
            ApiRequest.sellerSell(auditId,"SellerPretrialActivity_sellerSell");
        }
    ...
    public void setOnResponseCallback(String method, BaseRet baseRet) {
        ...
        if(method.equals("SellerPretrialActivity_sellerSell")){
            SellerSellRet ret = (SellerSellRet)baseRet;
            if(ret.getData() == null){
                return;
            }
            tv_reserveAccount.setText(ret.getData().getReserveAccount());
            ...
            tv_noticeMobile.setText(ret.getData().getNoticeMobile());
            ...
            tv_noticeEmail.setText(ret.getData().getNoticeEmail());
        ...
        } else if(method.equals("SellerPretrialActivity_doPretrial_pass")){
        ...
        switch (v.getId()){
            ...
            case R.id.tv_pass:
                if(!TextUtils.isEmpty(auditId)){
                    ...
                    ApiRequest.doPretrial(auditId,"1","","SellerPretrialActivity_doPretrial_pass");
                }
                break;
            case R.id.tv_refuse:
                if(!TextUtils.isEmpty(auditId)){
