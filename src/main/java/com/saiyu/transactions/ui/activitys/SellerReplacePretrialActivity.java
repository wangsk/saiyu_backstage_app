...
public class SellerReplacePretrialActivity extends BaseActivity implements CallbackUtils.ResponseCallback {
    ...
    private TextView tv_reserveAccount,tv_productInfo,tv_reserveInfo,tv_succQBCount,tv_succMoney,tv_confirmTypeStr,tv_rechargeTime,
            tv_finishTime,tv_receiveOrderNum,tv_onceLimit,tv_buyerAccount,tv_buyerRealName,tv_sellerAccount,tv_sellerRealName,
            tv_createTime,tv_penaltyMoney,tv_autoConfirmTime,tv_averageConfirmTime,tv_place,tv_mobile,tv_psw,tv_qq,tv_orderAccount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_pretrial_replace_layout);
        ...
        tv_title_content.setText("代理确认审核");
        ...
        CallbackUtils.setCallback(SellerReplacePretrialActivity.this);
        if(!TextUtils.isEmpty(auditId)){
            ApiRequest.customerRepacePretrial(auditId,"SellerReplacePretrialActivity_customerRepacePretrial");
        }
    ...
    public void setOnResponseCallback(String method, BaseRet baseRet) {
        ...
        if(method.equals("SellerReplacePretrialActivity_customerRepacePretrial")){
            SellerReplaceRet ret = (SellerReplaceRet)baseRet;
            if(ret.getData() == null){
                return;
            }
            ...
            tv_mobile.setText("手机:"+ret.getData().getContactMobile());
        ...
        } else if(method.equals("SellerReplacePretrialActivity_doPretrial_pass")){
            Toast.makeText(App.getApp(), "审核成功", Toast.LENGTH_SHORT).show();
            finish();
        }
        else if(method.equals("SellerReplacePretrialActivity_refuse")){
        ...
        switch (v.getId()){
            ...
            case R.id.tv_pass:
                if(!TextUtils.isEmpty(auditId)){
                    ...
                    ApiRequest.doPretrial(auditId,"1","打款给卖家","SellerReplacePretrialActivity_doPretrial_pass");
                }
                break;
            case R.id.tv_refuse:
                if(!TextUtils.isEmpty(auditId)){
                    ...
                    ApiRequest.doPretrial(auditId,"2","改为买家确认","SellerReplacePretrialActivity_refuse");
                }
                break;
        }
    }
